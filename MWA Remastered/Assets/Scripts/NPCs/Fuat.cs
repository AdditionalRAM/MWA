...
public class Fuat : NPCDialogue, IUseSaveGame
{
    ...
    public void SussyLocalize()
    {
        ...
        yesHearts = LocalManager.LocalizeArray(yesHearts);
        noHearts = LocalManager.LocalizeArray(noHearts);
        afterKey = LocalManager.LocalizeArray(afterKey);
    }
    ...
    {
        SaveGame.fuatDialog1 = saidDialog1;
        SaveGame.fuatKeyGiven = keyGiven;
    }

    public void OnAfterGameLoad()
    {
        saidDialog1 = SaveGame.fuatDialog1;
        keyGiven = SaveGame.fuatKeyGiven;
        heartsTaken = SaveGame.fuatKeyGiven;
        CheckVars();
    }
    ...
    public void CheckVars()
    {
        if (saidDialog1)
        {
            ...
            }else if (keyGiven) currentlySayingDialogs = afterKey;
        }        
    }
